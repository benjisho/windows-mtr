...
| MSI Installer | ✅ Released (superseded by portable ZIP in v1.1.3+) | v1.0.0 |
...
| Versioned JSON & CSV export | ✅ Released (`schema_version: "1.0"` added to CLI JSON output; `--csv <PATH>` introduced for CSV export) | v1.3.x |
